...
import 'package:udsaholoan/constant/component/custom_button_persetujuan.dart';
...
class TransaksiDalamprosesPage extends StatelessWidget {
  final transaksiC = Get.find<DashboardAdminController>();

  TransaksiDalamprosesPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
          stream: transaksiC.streamTransaksi('Dalam Proses'),
                ...
                return Padding(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      onTap: () async {
                        Get.defaultDialog(
                          title: 'Ubah Status Belanja',
                          content: Column(
                            children: [
                              CustomButtonPersetujuan(
                                onTap: () {
                                  transaksiC.updateStatusBelanja(
                                    statusBelanja: 'Selesai',
                                    doc: kelolaRiwayat.id,
                                  );
                                },
                                title: 'Selesai',
                              ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomRowTransaksi(
                                ...
                                dataTransaksi:
                                    kelolaRiwayat['quantity'].toString(),
                              ),
                              CustomRowTransaksi(
                                title: 'Total Pesanan',
                                dataTransaksi: formatCurrency
                                    .format(kelolaRiwayat['price']),
                              ),
                              const SizedBox(
                                height: 10.0,
                              ),
